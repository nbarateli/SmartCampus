...
public class RoomManager {
    ...
    public List<Room> findRooms(RoomSearchQuery query) {
        ...
        try {
            ...
            while(matches.next()) {
                int id = matches.getInt(SQLConstants.SQL_ROW_ROOM_ID);
                int capacity = matches.getInt(SQLConstants.SQL_ROW_ROOM_CAPACITY);
                int floor = matches.getInt(SQLConstants.SQL_ROW_ROOM_FLOOR);
                String name = matches.getString(SQLConstants.SQL_ROW_ROOM_NAME);
                RoomType roomType = 
                        RoomType.valueOf(matches.getString(SQLConstants.SQL_ROW_ROOM_TYPE));
                SeatType seatType = 
                        SeatType.valueOf(matches.getString(SQLConstants.SQL_ROW_ROOM_SEAT_TYPE));
                boolean available = matches.getBoolean(SQLConstants.SQL_ROW_ROOM_AVAILABLE);
    ...
    public void addRoom(Room room) {
        String insertQuery = "insert into " + SQLConstants.SQL_TABLE_ROOM + " (" +
                SQLConstants.SQL_ROW_ROOM_NAME + ", " + SQLConstants.SQL_ROW_ROOM_FLOOR + ", " +
                SQLConstants.SQL_ROW_ROOM_TYPE + ", " + SQLConstants.SQL_ROW_ROOM_CAPACITY + 
                ", " + SQLConstants.SQL_ROW_ROOM_AVAILABLE + ", " + 
                SQLConstants.SQL_ROW_ROOM_SEAT_TYPE + ") values (" +
