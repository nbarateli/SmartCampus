                ...
                <div align="center" id="right-div">
                  ...
                  <%
                    ...
                    for (Room room : rooms) {
                        ...
                        out.println("<div>ოთახის ტიპი: "
                                + roomTypeToString(room.getRoomType()) + ".</div>");
                        ...
                        out.println("</div>");
                        out.println("<div>ადგილის ტიპი: "
                                + seatTypeToString(room.getSeatType()) + ".</div>");
                        out.println("</div>");
                        out.println("</div>");
