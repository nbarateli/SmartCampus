		...
		<tr>
			<td id="left-td">
				...
				<form id="search-form" action="index.jsp" method="get"
					class="form-vertical" accept-charset="UTF-8">
					<input type="hidden" name="search" value="true"
						class="form-control">

					<div class="form-group">
						<label class="control-label" for="name">ოთახის სახელი</label> <input
							type="text" name="room_name" class="form-control" id="name"
							placeholder="შეიყვანეთ ოთახის სახელი">
					</div>

					<div class="form-group">
						<label class="control-label" for="floor">სართული</label> <input
							type="number" name="room_floor" class="form-control" id="floor"
							placeholder="შეიყვანეთ სართული">
					</div>

					<div class="form-group" id="capacity">
						<label class="control-label" for="capacity"> ადგილების
							რაოდენობა</label> <input type="number" name="capacity_from"
							class="form-control" title="-დან"
							placeholder="ადგილების რაოდენობა(-დან)"> <br> <input
							type="number" name="capacity_to" class="form-control"
							title="-მდე" placeholder="ადგილების რაოდენობა(-მდე)">
					</div>

					<div class="select">
						<label class="control-label" for="room_type">ოთახის ტიპი</label> <select
							name="room_type" class="form-control" id="room_type">
					...
					<div class="select">
						<label class="control-label" for="seat_type">ადგილების
							ტიპი</label> <select name="seat_type" class="form-control" id="seat_type">
							...
							<option value="plastic_chair">სკამ-მერხები (პლასტმასის)</option>
					...
					<div class="checkbox">
						<label class="control-label" for="can_be_booked"> <input
							type="checkbox" name="can_be_booked" id="can_be_booked">
							შეიძლება სტუდენტისთვის
						</label>
					</div>

					<div class="checkbox">
						<label class="control-label" for="problems"> <input
							type="checkbox" name="no_problems" id="problems">
							პრობლემების გარეშე
						</label>
					</div>
				...
				<div align="center" id="right-div">
					...
					<table>
						...
						<%
							...
							for (Room room : rooms) {
								out.println("<tr>");
								out.println("<td id=\"room-id-td\">" + "<a href=room.jsp?id=" + room.getRoomID() + ">"
								...
								out.println("<td>ოთახის ტიპი: " + roomTypeToString(room.getRoomType()) + ".</td>");
								...
								out.println("</td> ");
								out.println("<td>ადგილის ტიპი: " + seatTypeToString(room.getSeatType()) + ".</td>");
								out.println("</tr>");
								out.println("</tr>");
								out.println("</table>");
								out.println("</td>");
